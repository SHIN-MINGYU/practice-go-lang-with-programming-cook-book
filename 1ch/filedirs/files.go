...
// Capitalizer function read file and write the content to second file
...
// CapitalizerExample function create two files
// After write content in first file, in both of two file, call Capitalizer function 
